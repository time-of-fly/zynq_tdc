...
HD_PWD='F:/Users/wen02/Documents/GitHub/zynq_tdc/TDCsystem/TDCsystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDCsystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDCsystem_wrapper.tcl -notrace
